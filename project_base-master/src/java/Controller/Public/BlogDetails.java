...
//        }
            ...
            CategoryBlogDao bd = new CategoryBlogDao();
            int blogid = Integer.parseInt(request.getParameter("blogid"));
            List<CategoryBlog> ltdBlog = bd.getAllCategoryBlog();
            Blog blog = d.getBlogById(blogid);
            if(blog==null){
            response.sendRedirect("HomePage");
            }
            request.setAttribute("blog", blog);
            request.setAttribute("listcategory", ltdBlog);
