...
public class UpdateOrderUser extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<OrderDetail> listorderdetails = odd.GetAllOrderDetailByOrderId(oid);
        for (OrderDetail o : listorderdetails) {
            cd.Addtocart(uid, o.getProduct_id(), o.getQuantity());
            pd.AddQuantity(o.getProduct_id(), o.getQuantity());
        }
