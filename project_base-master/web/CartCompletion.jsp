<%-- 
    ...
    Created on : May 27, 2023, 1:14:52 PM
    Author     : vieta
--%>
                        ...
                        <div class="product-details">
                            <div class="col-sm-7">
                                ...
                                <div class="order-status">
                                    <h2>Order Success</h2>
                                    <p>Thank you for ordering from us! Your order has been successfully processed and will be delivered as soon as possible.</p>
                                </div>
                                <div class="order-summary">
                                    ...
                                    <table>
                                        ...
                                        <c:forEach var="cart" items="${lsitCart}">
                                            <tr>
