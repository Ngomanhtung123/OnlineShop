                                            ...
                                            <tbody>
                                                <c:forEach var="f" items="${feedbackList}">
                                                    <tr>
                                                        ...
                                                        <td><img src="${f.product.img_product}" width="100px"></td>
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="form-group col-md-6">
                                                                        <label for="exampleSelect1" class="control-label">Email</label>
                                                                        <input class="form-control" type="text" value="${f.user.email_address}" readonly="">
                                                                        <span id="invalid1" style="color: red;"> </span>
                                                                    ...
                                                                    <div class="form-group col-md-6">
                                                                        <label for="exampleSelect1" class="control-label">Rate Star</label>
                                                                        <input class="form-control" type="text" id="stitle" value="${f.rate_star}" readonly="">
                                                                        <span id="invalid1" style="color: red;"> </span>
