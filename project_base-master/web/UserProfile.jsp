...
<html lang="en">
    <head>
        ...
        <title>User Profile | E-Shopper</title>
                            ...
                            <ul class="nav navbar-nav">
                                <ul class="nav navbar-nav">
                                    <c:if test="${sessionScope.u!=null}">
                                        <li><a href="./ChangePassword"><i class="fa fa-refresh"></i> Change Password </a></li>
                                        
                                        <li><a href="./MyOrders"><i class="fa fa-product-hunt" aria-hidden="true"></i>My Order </a></li>
                                        <li><a href="./CartDetails"><i class="fa fa-shopping-cart"></i>Cart </a></li>
                                        </c:if>
                                        <c:if test="${sessionScope.u==null}">
                                        <li><a href="./UserRegister"><i class="fa fa-lock"></i> Register</a></li>
                    ...
                    <div class="col-sm-4">
                        <div class="signup-form" style="display: flex; flex-direction: column; align-items: center; justify-content: center;"><!--sign up form-->
                            ...
                            <div style="border-radius: 50%; width: 150px; height: 150px;overflow: hidden;">
                                <img id="curAvt" style="width: 100%;"  src="${sessionScope.u.avartar}">
                            </div>
                            <form action="UserProfile" method="post">
                                <label>Avatar</label>   <input type="file" style="background-color: white;" id="fbimg" name="fbimg" onchange="changeFbimg()" accept=".jpg, .jpeg, .png"><br>
                                <span  id="invalid1" style="color: red;" > </span>
                                <input name="img" id="sendimg" type="hidden" >
                                <label>Full Name</label>  <input style=" width: 300px;" type="text" placeholder="Full Name" value="${sessionScope.u.fullname}" name="fullname" required="" maxlength="50"/>
                                <label>Username</label>     <input type="text" placeholder="Username" value="${sessionScope.u.username}" name="username" required="" maxlength="50"/>
                                <label>Email Address</label>      <input type="email" placeholder="Email Address" readonly="" value="${sessionScope.u.email_address}" name="email"required="" maxlength="50"/>
                                <label>Phone</label>      <input type="text" placeholder="Phone" value="${sessionScope.u.phone_number}" name="phone"required="" maxlength="11"/>
                                <label>Address</label>     <input type="text" placeholder="Address" value="${sessionScope.u.address}" name="address" required="" maxlength="100"/>
                                <label>Gender:</label>      <input type="radio" value="1" ${sessionScope.u.gender==1?"checked":""}  style="display: inline-block; width: auto;margin: 0; padding: 0; height: auto;" checked="" name="gender"/> Male 
                                <input style="display: inline-block; width: auto;margin: 0; padding: 0; height: auto;"  ${sessionScope.u.gender==0?"checked":""} type="radio" value="0" name="gender"/> Female
