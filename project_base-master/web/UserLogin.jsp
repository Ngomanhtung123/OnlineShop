                    ...
                    <div class="col-sm-4">
                        <div class="signup-form"><!--sign up form-->
                            ...
                            <form action="UserLogin" method="post">
                                <input type="email" placeholder="Email Address" name="name" required="" maxlength="50"/>
                                <input type="password" placeholder="Password" name="pass" minlength="4" maxlength="32"/>
                                <p style="color: yellow;"><a href="resetpassword"> Forget Password </a></p>
                                <p style="color: yellow;"><a href="UserRegister"> Register New Account </a></p>
