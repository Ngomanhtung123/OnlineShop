<%-- 
    ...
    Created on : May 27, 2023, 1:08:21 PM
    Author     : vieta
--%>
...
<html lang="en">
                            ...
                            <div class="col-sm-5">
                                ...
                                <div id="similar-product" class="carousel slide" data-ride="carousel">
                                    ...
                                    <div class="carousel-inner">
                                        <%int count=0;%>
                                        <c:forEach items="${listimg}" var="lm">
                                            <%if(count == 0){
                                                count++;
                                            %>
                                            ...
                                            <a href=""><img src="${lm}" alt="" style="width: 500px; height: 400px"></a>
    ...
    <!--                                    <img src="${product.thumbnail}" class="newarrival" alt="" />-->
                                        <h2>${product.name_product}</h2>
                                        <p>Product ID: ${product.product_id}</p>
    <!--                                    <img src="${product.thumbnail}" alt="" />-->
                                        <span>
                                            <span><del>$${product.original_prices}</del></span><br>
                                            <p>$${product.sale_prices}</p><br>
                                            <label>Quantity:</label>
                                            <label>${product.quantity}</label>
                                            <hr>
                                            <label>Product Detail:</label>
                                            <p>${product.product_detail}</p>
                                            <a href="CartDetails?productID=${product.product_id}" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                                        </span>
