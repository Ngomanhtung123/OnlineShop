<%-- 
    Document   : MyOrders
    Created on : May 27, 2023, 1:50:49 PM
    Author     : vieta
--%>
                ...
                <div class="row">
                            ...
                            <div class="panel-group category-products" id="accordian"><!--category-productsr-->
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title"><a href="search?keyword=${lc.category_id}&check=${false}&pricerange=">${lc.category_name}</a></h4>
                                    </div>
                                </div>
                                </c:forEach>
                            </div>
                    ...
                    <div class="col-sm-9 padding-right">
                        <div class="product-details"><!--product-details-->
                            <h3 class="box-title">Your Order List</h3>
                            <table class="table table-bordered" style="width: 100%;" id="tablepro">
                                <thead>
                                    <tr>
                                        <th >Order Id </th>
                                        <th >Order Date</th>
                                    ...
                                    <c:forEach var="o" items="${ol}">
                                        <tr class="cart_item">
                                            <td class="product-thumbnail" >
                                                <a href="OrderInformation?oid=${o.order_id}">${o.order_id}</a>
                                            </td>
