                    ...
                    <div class="col-sm-4">
                        <div class="feedback-content">
                            ...
                            <div class="main-content">
                                ...
                                <c:if test="${msg==null}">
                                <form action="Feedback" method="post" onsubmit="return checkInput();">
                                    <div class="product-info">
                                        <h3>Product Information</h3>
                                        <p><b>Name: </b>${product.name_product}</p>
                                        <p><b>Price: </b>${product.original_prices} $ </p>
                                    </div>
                                    ...
                                    <input name="pid" value="${product.product_id}" type="hidden">
